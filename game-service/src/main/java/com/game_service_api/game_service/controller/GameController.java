...
public interface GameController {
    ...
    ResponseEntity<GameModel> createGame(@RequestHeader("userIdRequest") String userId, @Valid @RequestBody CreateGame createGame) throws GameException;
    @GetMapping(value = "{gameId}")
    ResponseEntity<GameModel> getGame(@RequestHeader("userIdRequest") String userId,@PathVariable Long gameId) throws GameException;
