...
public class AuthControllerImpl implements AuthController {
    ...
    @Override
    public ResponseEntity<TokenResponse> createUser(CreateUser createUser) throws AuthException {
        return ResponseEntity.ok(authService.createUser(createUser));
    }

    @Override
    public ResponseEntity<TokenResponse> loginUser(LoginUser loginUser) throws AuthException {
