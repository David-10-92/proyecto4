...
public interface GameController {
    ...
    ResponseEntity<GameModel> createGame(@RequestHeader("userIdRequest") String userId, @Valid @RequestBody CreateGame createGame);
    @GetMapping(value = "{gameId}")
    ResponseEntity<GameModel> getGame(@RequestHeader("userIdRequest") String userId,@PathVariable Long gameId);
